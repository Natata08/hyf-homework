...
const maxNumberWords = 1;
const findShortTitlesMovies = (movies) =>
  movies.filter((movie) => movie.title.split(' ').length <= maxNumberWords);

// Create an array of movie titles with long movie titles
const minNumberWords = 10;
const getLongTitles = (movies) =>
  movies
